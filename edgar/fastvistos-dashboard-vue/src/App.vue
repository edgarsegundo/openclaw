...
<template>
  <div style="width: 100%; color: #fff; font-family: sans-serif; box-sizing: border-box;">

    <!-- Cards de gráficos -->
    <div style="display: flex; gap: 20px; margin-bottom: 32px; padding: 0 12px;">
    ...
    <!-- Título e Tabs -->
    <div style="padding: 0 12px; margin-bottom: 0;">
      <div style="font-size: 22px; font-weight: 700; margin-bottom: 20px;">Transações</div>

      <div style="display: flex; border-bottom: 2px solid #2a2a2a; margin-bottom: 0;">
        <button
    ...
    <!-- Tabela full width, sem card wrapper -->
    ...
    <!-- Paginação -->
    <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 24px; flex-wrap: wrap; gap: 12px; padding: 0 12px;">
